...
/**
 * Use case to get featured products with pagination.
 */
@Service
@RequiredArgsConstructor
public class GetFeaturedProductsPaginatedUseCase {
    ...
    public PagedResponse<ProductDto> execute(int page, int size) {
        Page<BaseProduct> productsPage = unifiedProductService.findFeaturedPaginated(page, size);
