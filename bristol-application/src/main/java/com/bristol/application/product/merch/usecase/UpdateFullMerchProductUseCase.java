...
public class UpdateFullMerchProductUseCase {
    ...
    @Transactional
    public MerchProductDto execute(String id, UpdateFullMerchProductRequest request) {
        ...
        MerchProduct saved = merchProductRepository.save(product.update(
